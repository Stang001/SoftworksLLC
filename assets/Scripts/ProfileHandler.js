...
async function showData(){
    ...
    const LocalUserRequest = await(fetch(`${API_URL}/${(await profileapply).payload.id}`))
    ...
    if(profileapply.valid){
        document.getElementById("Usernameshow").textContent = profileapply.payload.username;
        document.getElementById("Emailshow").textContent = localStorage.getItem("email")
...
document.getElementById("logoutButton")
    ...
    document.getElementById("save_edit_password").addEventListener("click",async(param)=>{
        ...
        let userData = await fetch(`${API_URL}/${profileapply.payload.id}`);
        ...
        let response = await fetch(`${API_URL}/${profileapply.payload.id}`, {
            method: "PUT",
...
$('#save_edit_email').click(async(param)=>{
    ...
    $.ajax({
        type: "PUT",
        url: `${API_URL}/${profileapply.payload.id}`,
        dataType: "json",
        data:{email:newemail},
        beforeSend: function() {
